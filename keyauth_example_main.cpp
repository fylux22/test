...
// KeyAuth credentials as provided by user
std::string name = skCrypt("Flux Ware").decrypt(); // App name
std::string ownerid = skCrypt("pEdaaKQNmZ").decrypt(); // Account ID
std::string version = skCrypt("1.0").decrypt(); // Application version. Used for automatic downloads
